# 01.22.2021
"""
Displays a numbered menu to console and returns a corresponding 
function or object based on user number selection using a passed 
*expanded list/tuple.

Import it and pass it an *expanded list of tuples/lists. It will 
return list[1] for your selection by default. Pass the optional 
listreturn= argument an integer to return a different list item. 
"""
